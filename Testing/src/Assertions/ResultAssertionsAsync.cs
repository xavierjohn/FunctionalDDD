...
{
    /// <summary>
    /// Awaits the Task and returns assertions for the Result.
    /// </summary>
    /// <typeparam name="TValue">The type of the result value.</typeparam>
    /// <param name="resultTask">The task containing the result.</param>
    /// <returns>Assertions for the awaited Result.</returns>
    public static async Task<ResultAssertions<TValue>> Should<TValue>(this Task<Result<TValue>> resultTask)
    {
    ...
    /// <summary>
    /// Awaits the ValueTask and returns assertions for the Result.
    /// </summary>
    /// <typeparam name="TValue">The type of the result value.</typeparam>
    /// <param name="resultTask">The ValueTask containing the result.</param>
    /// <returns>Assertions for the awaited Result.</returns>
    public static async Task<ResultAssertions<TValue>> Should<TValue>(this ValueTask<Result<TValue>> resultTask)
    {
        var result = await resultTask.ConfigureAwait(false);
        return new ResultAssertions<TValue>(result);
    }
    ...
    {
        var assertions = await resultTask.Should().ConfigureAwait(false);
        return assertions.BeSuccess(because, becauseArgs);
    }
    ...
    {
        var assertions = await resultTask.Should().ConfigureAwait(false);
        return assertions.BeFailure(because, becauseArgs);
    }
    ...
    {
        var assertions = await resultTask.Should().ConfigureAwait(false);
        return assertions.BeFailureOfType<TError>(because, becauseArgs);
    }
}
