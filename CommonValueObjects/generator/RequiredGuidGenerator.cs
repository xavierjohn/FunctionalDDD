...
public partial class {g.ClassName} : Required{g.ClassType}<{g.ClassName}>
{{
...
";
        ...
        private static List<RequiredToGenerate> GetTypesToGenerate(Compilation compilation, IEnumerable<ClassDeclarationSyntax> classes, CancellationToken cancellationToken)
        {
            ...
            var requiredStringStr = "FunctionalDDD.CommonValueObjects.RequiredString`1";
            ...
            foreach (var classDeclarationSyntax in classes)
            {
                ...
                classToGenerate.Add(new RequiredToGenerate(@namespace, className, @base, classType));
            }
