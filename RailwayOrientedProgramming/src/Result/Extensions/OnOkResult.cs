...
public static partial class ResultExtensions
{
    ...
    ///     Selects result from the return value of a given function. If the calling Result is a failure, a new failure result is returned instead.
    /// </summary>
    public static async Task<Result<TResult, Error>> OnOkAsync<TOk, TResult>(this Task<Result<TOk, Error>> resultTask, Func<TOk, Task<Result<TResult, Error>>> func)
    {
        Result<TOk, Error> result = await resultTask.ConfigureAwait(false);
        return await result.OnOkAsync(func).ConfigureAwait(false);
    }

    /// <summary>
    ///     Selects result from the return value of a given function. If the calling Result is a failure, a new failure result is returned instead.
    /// </summary>
    public static async Task<Result<TResult, Error>> OnOkAsync<TOk, TResult>(this Task<Result<TOk, Error>> resultTask, Func<TOk, Result<TResult, Error>> func)
    {
        Result<TOk, Error> result = await resultTask.ConfigureAwait(false);
    ...
    /// </summary>
    public static async ValueTask<Result<TResult, Error>> OnOkAsync<TOk, TResult>(this ValueTask<Result<TOk, Error>> resultTask, Func<TOk, ValueTask<Result<TResult, Error>>> valueTask)
    {
        Result<TOk, Error> result = await resultTask;
        return await result.OnOkAsync(valueTask);
    }

    /// <summary>
    ///     Selects result from the return value of a given valueTask action. If the calling Result is a failure, a new failure result is returned instead.
    /// </summary>
    public static async ValueTask<Result<TResult, Error>> OnOkAsync<TOk, TResult>(this ValueTask<Result<TOk, Error>> resultTask, Func<TOk, Result<TResult, Error>> func)
    {
        Result<TOk, Error> result = await resultTask;
        return result.OnOk(func);
    }
