...
public class BindTests_ValueTask : OkTestsBase
{
    ...
    {
        Result<K, Error> output = await ValueTask_Failure_T().OnOkAsync(Func_T_ValueTask_Success_K);
    ...
    {
        Result<K, Error> output = await ValueTask_Success_T(T.Value).OnOkAsync(Func_T_ValueTask_Success_K);
