namespace RailwayOrientedProgramming.Tests.Functional.Results.Extensions
{
    ...
    public class BindTests_ValueTask_Right : OkTestsBase
    {
        ...
        {
            Result<K, Error> output = await Failure_T().OnOkAsync(Func_T_ValueTask_Success_K);
        ...
        {
            Result<K, Error> output = await Success_T(T.Value).OnOkAsync(Func_T_ValueTask_Success_K);
