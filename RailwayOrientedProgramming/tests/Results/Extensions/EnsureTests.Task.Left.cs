...
public class EnsureTests_Task_Left
{
    ...
    {
        var result = Task.FromResult(Result.Failure<string, Err>(Err.Conflict("initial error message")));
    ...
    {
        var tResult = Task.FromResult(Result.Failure<string, Err>(Err.Conflict("initial error message")));
    ...
    {
        var tResult = Task.FromResult(Result.Success<string, Err>("initial ok"));
    ...
    {
        var tResult = Task.FromResult(Result.Success<int?, Err>(null));

        Result<int?, Err> result = await tResult.EnsureAsync(value => !value.HasValue, value => Err.Validation($"should be null but found {value}"));
    ...
    {
        var tResult = Task.FromResult(Result.Success<string, Err>(""));
    ...
    public async Task Ensure_Task_Left_with_successInput_and_successPredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(() => Result.Success<string, Err>("Success message"));
    ...
    public async Task Ensure_Task_Left_with_successInput_and_failurePredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(() => Result.Failure<string, Err>(Err.Unexpected("Error message")));
    ...
    {
        var initialResult = Task.FromResult(Result.Failure<string, Err>(Err.Unexpected("Initial Error message")));
    ...
    public async Task Ensure_Task_Left_with_successInput_and_parameterisedFailurePredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(_ => Result.Failure<string, Err>(Err.Unexpected("Error Message")));
    ...
    public async Task Ensure_Task_Left_with_successInput_and_parameterisedSuccessPredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(_ => Result.Success<string, Err>("Success Message"));
    ...
    public async Task Ensure_Task_Left_with_failureInput_and_parameterisedFailurePredicate()
    {
        ...
        var result = await initialResult.EnsureAsync(_ => Result.Failure<string, Err>(Err.NotFound("Success Message")));
