...
public class BindTests_ValueTask : BindBase
{
    ...
    {
        Result<K, Error> output = await ValueTask_Failure_T().BindAsync(Func_T_ValueTask_Success_K);
    ...
    {
        Result<K, Error> output = await ValueTask_Success_T(T.Value).BindAsync(Func_T_ValueTask_Success_K);
