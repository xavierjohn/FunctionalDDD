...
public class BindTests_Task : OkTestsBase
{
    ...
    {
        Result<K, Error> output = await Task_Failure_T().OnOkAsync(Func_T_Task_Success_K);
    ...
    {
        Result<K, Error> output = await Task_Success_T(T.Value).OnOkAsync(Func_T_Task_Success_K);
    ...
    {
        var output = await Task_Failure_T().OnOkAsync(Success_T_Func_K);
    ...
    {
        var output = await Task_Success_T(T.Value).OnOkAsync(Success_T_Func_K);
    ...
    {
        var output = await Task_Failure_T_E().OnOkAsync(Success_T_E_Func_K);
    ...
    {
        var output = await Failure_T().OnOkAsync(Func_T_Task_Success_K);
    ...
    {
        var output = await Success_T(T.Value).OnOkAsync(Func_T_Task_Success_K);
