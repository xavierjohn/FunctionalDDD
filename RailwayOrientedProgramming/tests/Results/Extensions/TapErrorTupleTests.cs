...
public class TapErrorTupleTests : TestBase
{
    ...
    #region TapErrorAsync - CancellationToken Tuple Overloads

    [Fact]
    public async Task TapErrorAsync_Tuple2_Result_WithCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1);
        var actionExecuted = false;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_Result_WithErrorAndCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1);
        Error? capturedError = null;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_TaskResult_WithCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1).AsTask();
        var actionExecuted = false;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_Result_ValueTaskWithCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1);
        var actionExecuted = false;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_Result_ValueTaskWithErrorAndCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1);
        Error? capturedError = null;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_ValueTaskResult_WithCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1).AsValueTask();
        var actionExecuted = false;
    ...
    [Fact]
    public async Task TapErrorAsync_Tuple2_ValueTaskResult_WithErrorAndCancellation_FailureResult_ExecutesFunction()
    {
        // Arrange
        var result = Result.Failure<(int, string)>(Error1).AsValueTask();
        Error? capturedError = null;
