...
public static class HttpResultExtensionsAsync
{
    ...
    public static async Task<Microsoft.AspNetCore.Http.IResult> ToOkResultAsync<TValue>(this Task<Result<TValue>> resultTask)
    {
    ...
    /// <param name="resultTask">The result object.</param>
    /// <returns><see cref="Microsoft.AspNetCore.Http.IResult"/> </returns>
    public static async ValueTask<Microsoft.AspNetCore.Http.IResult> ToOkResultAsync<TValue>(this ValueTask<Result<TValue>> resultTask)
    {
        var result = await resultTask;
        return result.ToOkResult();
    }
