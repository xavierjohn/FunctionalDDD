...
/// <summary>
/// A specification that disables change tracking.
/// </summary>
/// <typeparam name="T">The entity type.</typeparam>
internal sealed class NoTrackingSpecification<T> : ISpecification<T> where T : class
{
    private readonly ISpecification<T> _inner;

    public NoTrackingSpecification(ISpecification<T> inner) => _inner = inner;
